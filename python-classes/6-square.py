#!/usr/bin/python3
"""Module that defines a Square class with size, position, and print."""
...
class Square:
    ...
    def position(self):
        ...
        Returns:
            tuple: The current position as a tuple of 2 positive integers.
        """
    ...
    def my_print(self):
        ...
        Prints an empty line if size is 0. Uses spaces for position offset.
        """
        if self.__size == 0:
            print("")
            return
